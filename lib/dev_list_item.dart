                            ...
                            Container(
                              ...
                              decoration: new BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                      fit: BoxFit.fill,
                                      image: NetworkImage("${developerModel.photoUrl}")
                                  )
                              ),
                            ),
                            Padding(
                              padding: EdgeInsets.all(8.0),
                              child: Text('${developerModel.name}', style: TextStyle(color: Colors.black, fontSize: 18.0, fontFamily: 'Raleway',),),
                            ),
                            Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: <Widget>[
                                IconButton(
                                    ...
                                    onPressed: () => _launchURL("mailto:${developerModel.email}")
                                ),
                                IconButton(
                                    icon: Icon(github_circle),
                                    onPressed: () => _launchURL("https://${developerModel.gitId}")
                                ),
                                IconButton(
                                    icon: Icon(xda),
                                    onPressed: () => _launchURL("${developerModel.xdaUrl}")
                                )
                              ],
                            )
                          ],
